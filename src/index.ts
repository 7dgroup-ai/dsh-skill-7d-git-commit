...
const DESCRIPTION = '7DGroup 提交规范适配 Skill：在生成 git commit message 前自动校验并套用 7DGroup 项目的提交规范，规避服务端 pre-receive hook 拦截。当用户需要 git commit 或生成提交信息时使用。'
...
// 都会覆盖本包技能。安装后会话中"看不到 7DGroup 版"多为该原因 ——
